    ...
    <div class="row justify-content-center ">
        ...
        <div class="col-md-16">
            <div class="card ">
              ...
              <h4 class="card-title text-dark">Kurs Ekle</h4> </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('course.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title.tr" name="title[tr]" required>
                            </div>
                        </div>
                        ...
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="text.en" name="text[en]" required>
                            </div>
                        </div>
                        ...
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="text.tr" name="text[tr]" required>
                            </div>
                        </div>
                   ...
                   <div class="col-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="text.ar" name="text[ar]" required>
                            </div>
                        </div>
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                <label for="description.en">{{__('course/create.discription')}} </label>
                                <textarea class="form-control" id="description.en" name="description[en]" rows="3" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description.tr" name="description[tr]" rows="3" required></textarea>
                            </div>
                        </div>
                        <div class="col-4 col-sm-4">
                            <div class="form-group">
                                <label for="description.ar">{{__('course/create.discription-ar')}} </label>
                                <textarea class="form-control" id="description.ar" name="description[ar]" rows="3" required></textarea>
                            </div>
                        </div>
                        </div>
                        </div>
